<?php
	...
	session_unset();
?>
	<p class="lead text-success">Pesanan Anda telah berhasil diproses. Silahkan periksa email Anda untuk mendapatkan konfirmasi pesanan dan detail pengiriman. Selamat belanja kembali :).</p>
