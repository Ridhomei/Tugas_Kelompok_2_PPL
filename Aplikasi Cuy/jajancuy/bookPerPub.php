<?php
	...
	if(mysqli_num_rows($result) == 0){
		echo "Stok Habis, Akan Restok Secepatnya :)";
		exit;
	}
...
?>
	<p class="lead"><a href="publisher_list.php">Jenis Jajan</a> > <?php echo $pubName; ?></p>
...
?>
	<div class="row">
		...
		<div class="col-md-7">
			...
			<a href="book.php?bookisbn=<?php echo $row['book_isbn'];?>" class="btn btn-primary">Detail</a>
		</div>
	</div>
	<br>
<?php
